    ...
    return (
        <div className="space-y-6">
            ...
            <div className="stat-card !p-0 overflow-hidden border border-white/5 group/container">
                {/* Form Section */}
                <div className="p-4 md:p-6 border-b border-white/5 bg-emerald-500/[0.01]">
                    <form onSubmit={handleAdd} className="flex flex-col md:grid md:grid-cols-12 gap-4 md:gap-5 items-end">
                ...
                <div className="hidden md:grid grid-cols-12 gap-4 px-8 py-4 bg-white/[0.03] border-b border-white/10 text-[9px] font-black text-zinc-500 uppercase tracking-[0.2em]">
                ...
                <div className="divide-y divide-white/[0.02] max-h-[500px] overflow-y-auto custom-scrollbar">
                    <AnimatePresence initial={false}>
                        {expenses.length === 0 ? (
                            <div className="py-24 flex flex-col items-center justify-center text-zinc-700 font-sans">
                                                ...
                                                <div className="flex items-start justify-between">
                                                    <div className="space-y-1">
                                                        <div className="font-mono font-black text-white text-lg">
                                                            {Number(expense.amount).toLocaleString(undefined, { minimumFractionDigits: 0 })}
                                                            <span className="text-zinc-500 text-xs ml-1 uppercase font-black">{currency}</span>
                                                        </div>
                                                    ...
                                                    <button
                                                        onClick={() => onDeleteExpense(expense.id)}
                                                        className="p-2 text-zinc-700 hover:text-amber-500 hover:bg-amber-500/5 rounded-xl transition-all"
                                                    >
                                                        <Trash2 className="w-4 h-4" />
                                                    </button>
                                                </div>
                                                <div className="flex items-center justify-between pt-2 border-t border-white/[0.05]">
                                                    <span className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest border border-white/5 bg-white/[0.02] ${colorClass}`}>
